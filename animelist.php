...
<head>
    ...
    <script>
        function insertli(value){
            return "<li class='link-decoration'><input class='temp' type='hidden'><span class='autowidth'>" +
                "" + value + " </span></li>"
        }
                        ...
                        echo"
                         <div style='height:50px; line-height:50px;' class=\"row\">
                            ...
                            <div style='padding-right:20px; vertical-align: middle;' class=\"pull-right\">
                                <a href='addanime.php'><button type=\"button\" class=\"btn btn-success\">Ajouter un anime</button></a>
                            </div>
                        </div>";
                    }
                    else{
                ...
                <form method="GET">
                    <div style="margin-bottom:10px;" class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4"><input type='submit' class='btn-success' value='Filtrer'></div>
                        </div>
                    </div>
                </form>
                <div class="dropdown">
