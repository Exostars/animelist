<?php
    ...
    $uploaddir = 'C:\wamp64\www\animelist\images/';
    $error = 0;
    ...
    if(isset($_POST['nom'])){
        ...
        if (move_uploaded_file($_FILES['smallimg']['tmp_name'], $uploadfile) && move_uploaded_file($_FILES['largeimg']['tmp_name'], $uploadlargefile)) {
            ...
            if($req->rowCount()) {
                ...
                $db->insertAnime($nom,$ep,$oav,$film,$note,$synopsis,$auteur,$studio,$img,$largeimg);
                ...
                <div class="container-fluid">
                    <form method="POST" enctype="multipart/form-data" id="addanimeform" action="addanime.php">
                        ...
                        <div style="margin-top:5px;" class="row">
                            ...
                            <textarea class="col-md-8 margintb nopaddinglf" style="resize:none;" name="synopsis" form="addanimeform" required></textarea>
                        </div>
                        <div style="margin-top:5px;" class="row">
                            <div class="col-md-4 margintb">Image (150x150) </div>
                            <input class="col-md-8 nopaddinglf margintb" name="smallimg" type="file" />
                        </div>
                        <div style="margin-top:5px;" class="row">
                            <div class="col-md-4 margintb">Image (1600x1000) </div>
                            <input class="col-md-8 nopaddinglf margintb" name="largeimg" type="file" />
                        </div>
                        <hr/>
                        <div style="margin-top:5px;" class="row">
